...
exports.run = async (bot, message, args) => {
  message.delete();
  const yasak = bot.emojis.get('701884491647549502');
  if (message.channel.id !== '701141469674864720') return message.channel.send(`${yasak} **Bu komutun kullanımı, bu kanalda engellenmiştir.**`).then(m => m.delete(5000));
